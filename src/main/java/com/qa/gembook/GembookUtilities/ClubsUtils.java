...
public class ClubsUtils {
    ...
    public static void clickOnClubsBtn() {
        try {
            ...
            click(Clubs_Locators.clubsBtn, "Click on Clubs Button", "Clicked Clubs Button");
        } catch (Exception exception) {
            GemTestReporter.addTestStep("User clicks on the Clubs button", "Exception arises " + exception, STATUS.FAIL, takeSnapShot());
        }
    }
    ...
    public static void myClubsAndAllClubsBtn() {
        try {
            ...
            GemTestReporter.addTestStep("Verify My Clubs and All Clubs buttons are displayed", "Exception arises " + exception, STATUS.FAIL, takeSnapShot());
    ...
    public static void colorOfHighlightedClubsBtn(String highlightedColor) {
        ...
        try {
            ...
            GemTestReporter.addTestStep("Verify " + getElementText(Clubs_Locators.selectedButton) + " Button is highlighted in " + highlightedColor + " or not", "Exception arises- " + exception, STATUS.PASS, takeSnapShot());
    ...
    public static void verifyClubsBtnClickable() {
        ...
        try {
            ...
            GemTestReporter.addTestStep("Verify the Clubs button is clickable", "Exception arises-" + exception, STATUS.FAIL, takeSnapShot());
    ...
    public static void logoOfClubCard(String clubslogo) {
        ...
        try {
            if (isExist(clubCardLogo)) {
                ...
                GemTestReporter.addTestStep("Verify the " + clubslogo + " card is displayed with the logo", "The Clubs card is displayed with the logo", STATUS.FAIL, takeSnapShot());
            }
        } catch (Exception exception) {
            GemTestReporter.addTestStep("Verify the " + clubslogo + " card is displayed with the logo", "Exception arises- " + exception, STATUS.FAIL, takeSnapShot());
        }
    }
    ...
    public static void clubsCardClickable(String name) {
        ...
        try {
            ...
            GemTestReporter.addTestStep("Verify the " + name + " card is clickable", "Exception arises-" + exception, STATUS.FAIL, takeSnapShot());
    ...
    public static void joinOrLeaveClubBtnOnCard(String name) {
        ...
        try {
            if (isExist(Clubs_Locators.getJoinClubBtnOnCard(name))) {
                click(Clubs_Locators.getJoinClubBtnOnCard(name));
            ...
            GemTestReporter.addTestStep("Verify " + getElementText(Clubs_Locators.getJoinClubBtnOnCard(name)) + " Button of " + name + " card is clicked", "Exception arises-" + exception, STATUS.FAIL, takeSnapShot());
        }
    }
