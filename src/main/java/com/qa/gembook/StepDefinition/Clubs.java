...
public class Clubs {
    ...
    public void clubsBtnName(String text) {
        ...
        try {
            ...
            GemTestReporter.addTestStep("Verify the Clubs button exists", "Exception arises-" + exception, STATUS.FAIL, takeSnapShot());
    ...
    public void clubsIcon() {
        ...
        try {
            ...
            GemTestReporter.addTestStep("Verify icon exists on the button", "Exception arises " + exception, STATUS.FAIL, takeSnapShot());
    ...
    public void clickOnAllClubs() {
        ...
        try {
            ...
            GemTestReporter.addTestStep("User Clicks on All Clubs Button", "Exception arises -" + exception, STATUS.FAIL, takeSnapShot());
